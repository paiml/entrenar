...
pub use cli::{
    ...
    CiteArgs, Cli, Command, DepositArgs, ExportArgs, ExportFormat, InfoArgs, LicenseArg, MergeArgs,
    MergeMethod, OutputFormat, PreregisterArgs, QuantMethod, QuantizeArgs, ResearchArgs,
    ResearchCommand, ResearchInitArgs, TrainArgs, ValidateArgs, VerifyArgs,
};
pub use infer::{
