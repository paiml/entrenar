...
mod tests {
    ...
    use crate::monitor::inference::path::tree::{LeafInfo, TreeSplit};

    // Helper to create a mock TreePath for testing
    ...
    fn test_forest_path_new_single_tree() {
        ...
        assert_eq!(forest.tree_agreement, 1.0); // Single tree has perfect agreement
    }
    ...
    fn test_forest_path_new_multiple_trees() {
        ...
        // Agreement should be less than 1.0 due to variance
    ...
    fn test_forest_path_compute_agreement_identical() {
        ...
        assert_eq!(agreement, 1.0); // Zero variance = perfect agreement
    }
    ...
    fn test_forest_path_compute_agreement_varied() {
        ...
        let agreement = ForestPath::compute_agreement(&predictions);
        // variance = 0.25, agreement = 1 / (1 + 0.25) = 0.8
    ...
    fn test_forest_path_confidence() {
        ...
        assert_eq!(forest.confidence(), 1.0); // Perfect agreement
    }
    ...
    fn test_forest_path_serialization_roundtrip() {
        ...
        let recovered = ForestPath::from_bytes(&bytes).unwrap();
    ...
    fn test_forest_path_from_bytes_version_mismatch() {
        let bytes = vec![2, 0, 0, 0, 0]; // version 2
