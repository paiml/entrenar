...
impl PruningSchedule {
    ...
    pub(super) fn cubic_sparsity_at_step(
        start_step: usize,
        end_step: usize,
        final_sparsity: f32,
        step: usize,
    ...
    pub(super) fn cubic_should_prune_at_step(
        start_step: usize,
        end_step: usize,
        step: usize,
    ) -> bool {
    ...
    pub(super) fn cubic_num_pruning_steps(start_step: usize, end_step: usize) -> usize {
        end_step - start_step + 1
    }

    /// Validate Cubic schedule.
    pub(super) fn cubic_validate(
        start_step: usize,
        end_step: usize,
        final_sparsity: f32,
    ) -> Result<(), String> {
    ...
    pub(super) fn cubic_is_complete(end_step: usize, step: usize) -> bool {
        step > end_step
    }
}
