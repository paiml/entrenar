...
// Fallback stubs for contract macros not in generated_contracts.rs.
// PMAT-517: These MUST cover every contract_pre_*/contract_post_* used in source
// but not generated by provable-contracts codegen. Without these, crates.io builds
// fail because the binding.yaml is not available outside the workspace.
